...
import { i18n, initI18n } from '@/shared/translations';
import { applyRtlForLanguage, isRtlLanguage } from '@/shared/utils/i18n-rtl';

import { LANGUAGE_STORAGE_KEY } from '@/shared/store/languageStorageKey';
