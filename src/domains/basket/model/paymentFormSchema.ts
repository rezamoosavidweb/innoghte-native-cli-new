...
const paymentFormValidation = z.discriminatedUnion('paymentType', [
  z.object({
...
export const basketPaymentFormResolver = zodResolver(paymentFormValidation);
export type BasketPaymentFormType = z.infer<typeof paymentFormValidation>;
export type BasketCreditCartType = z.infer<typeof creditCardValidationSchema>;
export type BasketCreditCartErrors = FieldErrors<{
  cart: Omit<BasketCreditCartType, 'cardNumber'> & { cardNumber: string };
}>;

export const basketCartTypeOptions = [
  { value: '1', label: 'Visa' },
