    ...
    >
      ...
      >
        <GiftGiveForm
          ...
          rooyeKhatsPending={courses.rooyeKhatsQuery.isPending}
          audioBooksPending={courses.audioBooksQuery.isPending}
          courseOptions={courses.courseOptions}
          albumOptions={courses.albumOptions}
          rooyeKhatOptions={courses.rooyeKhatOptions}
          audioBookOptions={courses.audioBookOptions}
