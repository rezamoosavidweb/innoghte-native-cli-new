...
import { LiveMeetingListCard } from '@/features/liveMeetings/components/cards/LiveMeetingListCard';
import type { LiveMeetingType } from '@/features/liveMeetings/types';
...
const LiveMeetingsScreenComponent = (_props: Props) => {
  const { data, isPending, isError, error } = useLiveMeetingsQuery();
