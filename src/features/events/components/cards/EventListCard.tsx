...
import {
  formatNumberForApp,
  formatPriceForApp,
} from '@/shared/utils/lib/formatLocaleNumbers';
import { useEventListCardStyles } from '@/features/events/styles/eventListCard.styles';
...
const EventListCardComponent = ({ item }: Props) => {
  ...
  const s = useEventListCardStyles(colors);
