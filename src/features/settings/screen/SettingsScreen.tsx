...
import type { AppLanguage } from '@/shared/bootstrap/readAppLanguage';
...
import type { ThemePreference } from '@/shared/store/uiTheme.store';
import { useUiThemeStore } from '@/shared/store/uiTheme.store';
import { useScreenScaffoldStyles } from '@/shared/styles/theme';
import { useSettingsScreenStyles } from '@/features/settings/styles';
